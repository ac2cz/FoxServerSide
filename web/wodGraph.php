...
msat-child/style.css" />
   ...
   $raw='conv';
   if ($port == "") $port = 8080;
   #echo ("http://localhost:8080/wod-field/$arg1/$arg2/$raw/$num/$reset/$uptime");
   $a = file_get_contents("http://localhost:$port/wod-field/$arg1/$arg2/$raw/$num/$reset/$uptime");
        ...
        function drawBasic() {
            ...
            var options = {
                ...
                titleTextStyle: {
                    ...
                    title: 
                        '<?php 
                            echo 'Fox ', getName($arg1), ' WOD ', $arg2, ' ';
                            if ($raw == 'conv')
                                echo 'Converted';
                            else echo 'Raw';
